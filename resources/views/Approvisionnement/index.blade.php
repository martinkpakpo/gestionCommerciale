                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="jarviswidget well" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
                            <div>
                                <form method="post" action="{{ route('LigneApprovisionnement.store') }}" class="form-horizontal" enctype="multipart/form-data">
                                    @csrf
                                    <fieldset>
                            ...
                            <div>
                                ...
                                <div class="widget-body">
                                    <div>
                                        ...
                                        <div class="widget-body">
                                            <div>
                                                <form method="post" action="{{ route('Approvisionnement.store') }}" class="form-horizontal" enctype="multipart/form-data" id="form-insert">
                                                    @csrf
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label">Date de livraison prévu</label>
                                                            <div class="col-md-10">
                                                                <input type="date" min="" class="form-control" id="date_livraison_pre" name="date_livraison_pre" onchange="selectDate();">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label">Validateur commande</label>
                                                            <div class="col-md-10">
                                                                <select style="width:100%" class="select2" name="validateur_id" id="validateur_id" onchange="selectValidateur();">
                                                    ...
                                                    <table class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><label id="date_livraison_pre_label"></label></td>
                                                            </tr>  
                                                            <tr>
                                                                <td>Validateur de commande</td>
                                                                <td><label id="validateur_id_label"></label></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table class="table table-bordered table-striped">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button class='btn btn-xs tablebutton tablebuttonvlick' onclick='deleteFromCart("{{$Cart->id}}")'>Supprimer <i class='fa fa-trash-o'></i></button>
                                                            </td>
...
document.getElementById('date_livraison_pre').setAttribute('min', new Date().toISOString().split('T')[0]);
...
function selectDate(){
  document.getElementById('date_livraison_pre_label').innerHTML = document.getElementById('date_livraison_pre').value;

}
function selectValidateur(){
    var fournisseur_value=$( "#validateur_id" ).val();
  if (fournisseur_value==="") {
    $.alert.open({
         type: 'error',
         title: 'Saisie invalide',
         draggable: false,
         content: "Sélectionner un validateur"
     });
  } else {
    document.getElementById('validateur_id_label').innerHTML = $( "#validateur_id option:selected" ).text();
